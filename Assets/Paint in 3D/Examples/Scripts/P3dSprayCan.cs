...
namespace PaintIn3D
{
	...
	public class P3dSprayCan : MonoBehaviour
	{
		...
		protected virtual void LateUpdate()
		{
			...
			this.Particles.startColor = ColorIndicator.Instance.color.ToColor();
			...
			if (aimSensitivity != 0.0f)
			{
				...
				this.gameObject.GetComponent<Renderer>().material.color = ColorIndicator.Instance.color.ToColor();
